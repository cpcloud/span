...
# mixed input
    ...
    def test_equality(self):
        ...
        od2 = OrderedDict(pairs)
        self.assertNotEqual(
            od1, od2)       # different order implies inequality
    ...
    def test_yaml_linkage(self):
        # Verify that __reduce__ is setup in a way that supports
        # PyYAML's dump() feature.
